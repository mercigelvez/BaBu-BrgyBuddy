# [Flask Argon Dashboard](https://appseed.us/product/babu/flask/)
...
- 👉 [Flask Argon Dashboard](https://appseed.us/product/babu/flask/) - product page
- 👉 [Flask Argon Dashboard](https://flask-babu.appseed-srv1.com/) - LIVE deployment
...
| Free Version                          | [PRO Version](https://appseed.us/product/babu2-pro/flask/)          | [Custom Development](https://appseed.us/custom-development/) |  
| --------------------------------------| --------------------------------------| --------------------------------------|
...
| ✓ `Free Support`                          |  -                                                                    |  -                                 |
| ---------------------------------         | ---------------------------------                                     | ---------------------------------  |
| ✓ [LIVE Demo](https://flask-babu.appseed-srv1.com)  | 🚀 [LIVE Demo](https://flask-argon-dash2-pro.onrender.com) `PRO` | 🛒 `Order`: **[$4,999](https://appseed.gumroad.com/l/rocket-package)** (GUMROAD) | 
...
```bash
$ git clone https://github.com/app-generator/flask-babu.git
$ cd flask-babu
```
...
- 👉 [Argon Dashboard PRO Flask](https://appseed.us/product/babu2-pro/flask/) - Product Page
...
---
[Flask Argon Dashboard](https://appseed.us/product/babu/flask/) - Open-source starter generated by **[App Generator](https://appseed.us/generator/)**.
